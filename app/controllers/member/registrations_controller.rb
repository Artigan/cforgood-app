class Member::RegistrationsController < Devise::RegistrationsController
  ...
  def user_params
    params.require(:user).permit(:first_name, :last_name, :password, :email, :picture, :picture_cloud, :picture_cloud_cache, :cause_id, :subscription, :birthday, :street, :zipcode, :city, :amount, :code_partner)
  end
end
