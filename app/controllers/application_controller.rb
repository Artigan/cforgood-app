class ApplicationController < ActionController::Base
  ...
  def after_sign_in_path_for(resource)
    # ---  COMMENTER LE TEMPS DU LE DEBUT DE LA BETA ---
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:first_name, :last_name, :email, :password, :remember_me, :password_confirmation, :name, :business_category_id, :city, :code_promo) }
