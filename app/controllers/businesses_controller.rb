class BusinessesController < ApplicationController
  ...
  def find_businesses_for_search
    @businesses = Business.not_supervisor.includes(:business_category, :main_address, :perks).active.with_perks_in_time.distinct.eager_load(:addresses).merge(Address.near(@lat_lng, 99999, order: "distance"))
  end
end
