class Pro::PerksController < Pro::ProController
  ...
  def perk_params
    params.require(:perk).permit(:name, :description, :perk_detail_id, :times, :start_date, :start_date_date, :start_date_hour, :end_date, :end_date_date, :end_date_hour, :perk_code, :picture, :active, :appel, :durable, :flash)
  end
end
